...
public class DynamoDBServiceImpl implements DynamoDBService {
    ...
    public String updateUser(Map<String, String> pathParameters, String inputBody) {
        ...
        */
        ...
        User userToUpdate = new Gson().fromJson(inputBody, User.class); //new User();
        ...
        if (existingUser != null) {
            ...
            existingUser.setInterests(userToUpdate.getInterests());
            existingUser.setLocation(userToUpdate.getLocation());
            existingUser.setEmail(userToUpdate.getEmail());
            existingUser.setCountry(userToUpdate.getCountry());
            existingUser.setName(userToUpdate.getName());
            existingUser.setSocialMedia(userToUpdate.getSocialMedia());
